...
class DebtExport implements FromCollection, WithHeadings, WithMapping,  ShouldAutoSize, WithStyles, WithColumnFormatting
{
    public function collection()
    {
        return Debt::with('user', 'user.branch', 'user.department', 'user.position', 'user.costCenter', 'user.financial')->get();
    }
